...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coolsnady/dcrd/chaincfg)
...
```bash
$ go get -u github.com/coolsnady/dcrd/chaincfg
```
