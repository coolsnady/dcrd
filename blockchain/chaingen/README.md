...
(http://godoc.org/github.com/coolsnady/dcrd/blockchain/chaingen)
...
* [Basic Usage Example]
  (http://godoc.org/github.com/coolsnady/dcrd/blockchain/chaingen#example-package--BasicUsage)  
...
```bash
$ go get -u github.com/coolsnady/dcrd/blockchain/chaingen
```
