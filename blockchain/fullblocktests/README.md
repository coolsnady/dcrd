...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coolsnady/dcrd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/coolsnady/dcrd/blockchain/fullblocktests
```
