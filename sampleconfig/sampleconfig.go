...
// FileContents is a string containing the commented example config for hxd2.
...
; The default is ~/.hxd2/data on POSIX OSes, $LOCALAPPDATA/hxd2/data on Windows,
; ~/Library/Application Support/hxd2/data on macOS, and $homed/hxd2/data on
; Plan9.  Environment variables are expanded so they may be used.  NOTE: Windows
; environment variables are typically %VARIABLE%, but they must be accessed with
; $VARIABLE here.
; datadir=~/.hxd2/data                            ; Unix
; datadir=$LOCALAPPDATA/hxd2/data                 ; Windows
; datadir=~/Library/Application Support/hxd2/data ; macOS
...
; line.  hxd2 will not contact 3rd-party sites to obtain external ip addresses.
...
; with, but the behavior is slightly different.  By default, hxd2 will query DNS
...
; Disable DNS seeding for peers.  By default, when hxd2 starts, it will use
...
; which is used to control and query information from a running hxd2 process.
;
...
; log level for individual subsystems.  Use hxd2 --debuglevel=show to list
