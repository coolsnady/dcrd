...
// list of commands that we recognize, but for which hxd2 has no support because
...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="hxd2 RPC"`)
