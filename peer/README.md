...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coolsnady/dcrd/peer)
...
```bash
$ go get -u github.com/coolsnady/dcrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/coolsnady/dcrd/peer#example-package--NewOutboundPeer)  
