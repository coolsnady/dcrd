...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case dcrjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid hxd2 connected "+
				"notification: %v", err)
			return
		}
...
// parseBtcdConnectedNtfnParams parses out the connection status of hxd2
...
//
// NOTE: This is a hxd2 extension and requires a websocket connection.
