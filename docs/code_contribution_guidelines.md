...
reason, the hxd2 suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire hxd2
...
One of the major design goals of all core hxd2 packages is to aim for complete
...
contributions.  This is how to get your changes into hxd2.
...
Rejoice as you will now be listed as a [contributor](https://github.com/hunjixin/dcrd/graphs/contributors)!
...
[ISC license](https://github.com/hunjixin/dcrd/blob/master/LICENSE).  This is
the same license as all of the code in the hxd2 suite.
